module tt_um_vga_snake (
    ...
    always @(posedge clk) begin
        ...
        if (!rst_n) begin
            ...
            // CONTROLS via Keyboard Arrow Keys / ui_in

            if (ui_in[0] && dir != 2'b01)      dir <= 2'b00; // UP

            else if (ui_in[1] && dir != 2'b00) dir <= 2'b01; // DOWN

            else if (ui_in[2] && dir != 2'b11) dir <= 2'b10; // LEFT

            else if (ui_in[3] && dir != 2'b10) dir <= 2'b11; // RIGHT
